...
def argsinstance():
    ...
    parser.add_argument(
        "--alias-hosted-zone-id", default="Z2FDTNDATAQYW2", type=str
    )  # Check https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53.html
    parser.add_argument("--alias-evaluate", default=True, type=bool)
